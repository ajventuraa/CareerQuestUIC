...
const RealEstateManagementScreen = props => {
              ...
              <>
                ...
                >
                  <View>
                    ...
                    >
                      {
                        'The BS REM program aims to prepare graduates for a career in the field of Real Estate Management in various corporations and institutions whether in the practice of salesmanship. brokerage, appraisal and consultancy including the local government practice of assessors and appraisers.'
                      }
                    </Text>
                  </View>
                </View>
...
export default withTheme(RealEstateManagementScreen);
